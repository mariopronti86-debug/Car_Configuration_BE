...
# GET BY CLIENT: recupera tutti i preventivi di un client tramite join con Configuration
...
# GET LAST: recupera l'ultimo preventivo inserito (per generare il numero progressivo)
