...
def create(session, data):
    ...
    if not data.get("name") or not data.get("brand") or not data.get("base_price") or not data.get("engine_id"):
...
# ── AGGIUNGI optional al catalogo del modello
...
# ── RIMUOVI optional dal catalogo del modello
